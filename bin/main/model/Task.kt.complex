    ...
    companion object {
        ...
        fun validate(title: String): ValidationResult {
            return when {
                ...
                title.length < 3 ->
                    ValidationResult.Error("Title must be at least 3 characters. Currently: ${title.length} characters.")

                title.length > 100 ->
                    ValidationResult.Error("Title must be less than 100 characters. Currently: ${title.length} characters.")
